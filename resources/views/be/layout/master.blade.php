...
<head>
    ...
    <!-- Choices JS -->
    <script src="{{ asset('template_be/assets/libs/choices.js/public/assets/scripts/choices.min.js') }}"></script>

    <!-- Main Theme Js -->
    <script src="{{ asset('template_be/assets/js/main.js') }}"></script>
    ...
    <!-- Icons Css -->
    <link href="{{ asset('template_be/assets/css/icons.css') }}" rel="stylesheet">

    <!-- Node Waves Css -->
    <link href="{{ asset('template_be/assets/libs/node-waves/waves.min.css') }}" rel="stylesheet">

    <!-- Simplebar Css -->
    <link href="{{ asset('template_be/assets/libs/simplebar/simplebar.min.css') }}" rel="stylesheet">

    <!-- Color Picker Css -->
    <link rel="stylesheet" href="{{ asset('template_be/assets/libs/flatpickr/flatpickr.min.css') }}">
    <link rel="stylesheet" href="{{ asset('template_be/assets/libs/@simonwep/pickr/themes/nano.min.css') }}">

    <!-- Choices Css -->
    <link rel="stylesheet"
        href="{{ asset('template_be/assets/libs/choices.js/public/assets/styles/choices.min.css') }}">
...
<body class="body">
    ...
    <!-- Loader -->
    <div id="loader">
        <img src="{{ asset('template_be/assets/images/media/loader.svg') }}" alt="loader">
    </div>
    <!-- Loader -->
        ...
        <footer class="footer mt-auto py-3 bg-white text-center">
            <div class="container">
                <span class="text-muted"> Copyright © <span id="year"></span> <a href="javascript:void(0);"
                        class="text-dark fw-semibold">Bun's Shop</a>.
                    Designed with <span class="bi bi-heart-fill text-danger"></span> by <a
                        href="https://www.facebook.com/marvelous.captain.75/">
                        <span class="fw-semibold text-primary text-decoration-underline">Marvelous ~ Vương Tuấn
                            Anh</span>
                    </a> All
                    rights
                    reserved
    ...
    <!-- Popper JS -->
    <script src="{{ asset('template_be/assets/libs/@popperjs/core/umd/popper.min.js') }}"></script>

    <!-- Bootstrap JS -->
    <script src="{{ asset('template_be/assets/libs/bootstrap/js/bootstrap.bundle.min.js') }}"></script>

    <!-- Defaultmenu JS -->
    <script src="{{ asset('template_be/assets/js/defaultmenu.min.js') }}"></script>

    <!-- Node Waves JS-->
    <script src="{{ asset('template_be/assets/libs/node-waves/waves.min.js') }}"></script>

    <!-- Sticky JS -->
    <script src="{{ asset('template_be/assets/js/sticky.js') }}"></script>

    <!-- Simplebar JS -->
    <script src="{{ asset('template_be/assets/libs/simplebar/simplebar.min.js') }}"></script>
    <script src="{{ asset('template_be/assets/js/simplebar.js') }}"></script>

    <!-- Color Picker JS -->
    <script src="{{ asset('template_be/assets/libs/@simonwep/pickr/pickr.es5.min.js') }}"></script>


    <!-- Apex Charts JS -->
    <script src="{{ asset('template_be/assets/libs/apexcharts/apexcharts.min.js') }}"></script>

    <!-- Sales dashbord JS -->
    <script src="{{ asset('template_be/assets/js/Sales.js') }}"></script>
    ...
    <!-- Custom JS -->
    <script src="{{ asset('template_be/assets/js/custom.js') }}"></script>
