...
@section('content')
    ...
    <div class="wg-box">
        <div class="flex items-center justify-between gap10 flex-wrap">
            ...
            <a class="tf-button style-1 w208" href="{{ route('admin.category.create') }}"><i class="icon-plus"></i>Thêm mới</a>
        </div>
                        ...
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <path
                                    ...
                                    stroke="#111111" stroke-width="0.7" stroke-miterlimit="10" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M16.9219 12.9388C14.2014 10.2183 9.79861 10.2183 7.07812 12.9388" stroke="#111111"
                                    stroke-width="0.7" stroke-miterlimit="10" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path
                        ...
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <g clip-path="url(#clip0_2774_3720)">
                                    <mask id="mask0_2774_3720" style="mask-type:luminance" maskUnits="userSpaceOnUse"
                        ...
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <g clip-path="url(#clip0_2774_1803)">
                                    <mask id="mask0_2774_1803" style="mask-type:luminance" maskUnits="userSpaceOnUse"
                                        x="0" y="0" width="24" height="24">
                                        <path d="M23.6499 23.65V0.350071H0.35V23.65H23.6499Z" fill="white"
                                            stroke="white" stroke-width="0.7" />
                                    </mask>
